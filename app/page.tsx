  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="about" data-testid="about-section" className="py-20 bg-terminal-surface">
        ...
        <section id="experience" data-testid="experience-section" className="py-20 bg-terminal-bg">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="mb-12">
        ...
        <section id="skills" data-testid="skills-section" className="py-20 bg-terminal-surface">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="mb-12">
        ...
        <section id="projects" data-testid="projects-section" className="py-20 bg-terminal-bg">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="mb-12">
        ...
        <section id="contact" data-testid="contact-section" className="py-20 bg-terminal-surface">
            ...
            <div className="bg-terminal-bg border border-terminal-border p-8 max-w-2xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-center space-x-4">
                  <a href="https://www.linkedin.com/in/joshua-jones-security/" target="_blank" rel="noopener noreferrer" className="text-terminal-gray hover:text-terminal-green transition-colors" aria-label="LinkedIn">
                  ...
                  <a href="https://github.com/JoshDoesIT" target="_blank" rel="noopener noreferrer" className="text-terminal-gray hover:text-terminal-green transition-colors" aria-label="GitHub">
